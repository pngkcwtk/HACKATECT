...
# ตรวจสอบสิทธิสวัสดิการ (e-Social Welfare)
...
# ระบบตรวขสอบสิทธิรักษาพยาบาล (สำนักสารสนเทศบริการสุขภาพ)
def scrape_med(citizen_id: str):
    print(f"🤖 Agent สั่งงาน: กำลังเริ่มขูดข้อมูลสำหรับเลขบัตร {citizen_id}...")
    ...
    with sync_playwright() as p:
        ...
        # 2. วาร์ปไปยังหน้าเว็บ e-Social Welfare ตรงจุดตรวจสอบสิทธิ์
        page.goto("https://cs8.chi.or.th/chkauth/e1")
